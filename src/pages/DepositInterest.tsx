          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="border-b border-slate-800 bg-slate-900/60">
                <tr><Th sticky>Depositor</Th><Th>DEP no.</Th><Th right>Outstanding</Th><Th>Period</Th><Th right>Interest</Th><Th right>Paid</Th><Th right>Pending</Th><Th>Status</Th>{editable && <Th>Pay</Th>}{isMd && <Th>Edit</Th>}</tr>
              </thead>
